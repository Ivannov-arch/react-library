...
const Zustand = React.lazy(
  () => import("./Advanced Concepts/state-management/Zustand/ZustandApp.jsx")
);
...
import {
  store,
  persistor,
} from "./Advanced Concepts/state-management/Redux/ReduxStore.jsx";
const Redux = React.lazy(
  () => import("./Advanced Concepts/state-management/Redux/ReduxApp.jsx")
);
...
const ConditionalRendering = React.lazy(
  () => import("./Basic Concepts/conditional-rendering/AppUG.jsx")
);
const RenderLists = React.lazy(
  () => import("./Basic Concepts/render-list/AppList.jsx")
);
const ClickEvents = React.lazy(
  () => import("./Basic Concepts/click-event/CeApp.jsx")
);

const UseStatesNav = React.lazy(() => import("./Pages/UseStatesNav.jsx"));
const UseState = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-state/UseState.jsx")
);
const UpdateArray = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-state/UpdateArrays.jsx")
);
const UpdateObject = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-state/UpdateObjects.jsx")
);
const UpdateArrayOfObject = React.lazy(
  () =>
    import("./Basic Concepts/react-hooks/use-state/UpdateArraysOfObjects.jsx")
);
const Counter = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-state/Counter.jsx")
);

const OnChange = React.lazy(
  () => import("./Basic Concepts/react-hooks/on-change/AppOnChange.jsx")
);
const UseEffect = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-effect/UseEffect.jsx")
);
const UseContext = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-context/UseContext.jsx")
);
const UseRef = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-ref/UseRef.jsx")
);
const UseReducer = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-reducer/UseReducer.jsx")
);
const UseImperativeHandle = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-imperative-handle/Uih.jsx")
);
const UseLayoutEffect = React.lazy(
  () =>
    import("./Basic Concepts/react-hooks/use-layout-effect/UseLayoutEffect.jsx")
);
const UseInsertionEffect = React.lazy(
  () =>
    import("./Basic Concepts/react-hooks/use-insert-effect/UseInsertEffect.jsx")
);
const UseId = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-id/UseId.jsx")
);
const UseTransition = React.lazy(
  () => import("./Basic Concepts/react-hooks/use-transition/UseTransition.jsx")
);
const UseDeferredValue = React.lazy(
  () =>
    import(
      "./Basic Concepts/react-hooks/use-deferred-value/UseDeferredvalue.jsx"
    )
);
const UseSyncExternalStore = React.lazy(
  () =>
    import(
      "./Basic Concepts/react-hooks/use-sync-external-store/UseSyncExternalStore.jsx"
    )
);
//#endregion
...
const UseCustomHooks = React.lazy(
  () => import("./Advanced Concepts/custom-hooks/UseCustomHooks.jsx")
);
const ErrorBoundaryApp = React.lazy(
  () => import("./Advanced Concepts/error-boundaries/ErrorBoundaryApp.jsx")
);

const PerformanceOptimization = React.lazy(
  () => import("./Pages/PerformancesNav.jsx")
);
const ReactMemo = React.lazy(
  () => import("./Advanced Concepts/performance-optimization/ReactMemo.jsx")
);
const UseMemo = React.lazy(
  () => import("./Advanced Concepts/performance-optimization/UseMemo.jsx")
);
...
const AustinReactQuery = React.lazy(
  () =>
    import(
      "./Advanced Concepts/react-query/austin-davis/AustinReactQueryApp.tsx"
    )
);
const WdsReactQueryApp = React.lazy(
  () => import("./Advanced Concepts/react-query/wds/WdsReactQueryApp.jsx")
);

const ReactHookForm = React.lazy(
  () => import("./Advanced Concepts/react-hook-form/RhfApp.tsx")
);
